  ...
  <vee-form  :validation-schema="loginSchema" @submit="login">
    ...
    <div class="mb-3">
      ...
      <vee-field  name="password"
        type="password" class="block w-full py-1.5 px-3 text-gray-800
...
export default {
  ...
  data() {
    return {
      ...
      login_alert_msg: 'Please wait, you are being directed to the music player app',
    };
  },
  methods: {
    async login(values) {
      ...
      this.login_alert_msg = 'Please wait, you are being directed to the music player app';
